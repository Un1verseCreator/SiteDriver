...
<html lang="ru">
<head>
<title>Водительское удостоверение - онлайн</title>
<meta charset="utf-8">
				...
				<div class='landing-con-left content-expand '>
					<div class="landing-con-container scale-content-txt-1 fade-in-onload">
						...
						<div class='landing-tx1-heading pulsate'>
							<h1>Водительское удостоверение<br>
							 Полностью онлайн</h1>
						</div>
						<div class='landing-tx2-heading'>
							<p>
							Вы можете оформить водительское удостоверение России, Казахстана и Республики Беларусь полностью онлайн
							</p>
				...
				<div class="search-con-inner">
					<div class="search-inp-search darkmode-search-border">
						...
						<div class="search-con-author darkmode-txt">
							<a href="/faq">
							<span class="darkmode-txt">Часто задаваемые вопросы</span>
							</span>
							</a>
						</div>
						<form action='/faq' method='get'>
							<input class="database-search darkmode-txt darkmode-search-bg" name="g" placeholder="Введите ваш вопрос">
						</form>
					</div>
				</div>
			</div>
					...
					<div class="github-con-mantra">
						<div class="github-wrp-mantra scale-content-txt-1 ">
							<div class="github-tx1-mantra darkmode-txt">
								<h2>ЛИШИЛИ ПРАВ? РЕШЕНИЕ ЕСТЬ!</h2>
								<div class="landing-con-divider">
								</div>
							</div>
							<div class="github-tx2-mantra darkmode-txt">
								<p>
								Лишили прав? Нет желания учиться в автошколе или не можете сдать экзамен? Еще нет 18 но уже хочется ездить? Решение есть! Вы можете купить казахские или белорусские права и двигаться по ним на территории России. Или мы можем изготовить для вас российские права с подбором «донора», то есть найдем данные подходящего человека и сделаем права с вашим фото и его данными. Это также позволит вам передвигаться без всяких проблем. Качество прав, купленных на нашем сайте, не отличается от оригинала. Например Вы можете быть уверенным, что права пройдут любые проверки и не вызовут подозрений. Такие права дают вам возможность «стать на время» белорусом или казахом, ведь во многих местах водительское удостоверение является удостоверением личности. Как вы можете это использовать решать вам, но иметь возможность на время стать другим человеком кажется неплохим козырем.
								</p>
							</div>
